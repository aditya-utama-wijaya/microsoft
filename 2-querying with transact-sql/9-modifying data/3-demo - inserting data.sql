...
VALUES
('2015-01-01T12:30:00', 'adventure-works\pamela0', 1, '245-555-0173', 'Returning call re: enquiry about deliery');
...
INSERT INTO SalesLT.CallLog(SalesPerson, CustomerID, PhoneNumber)
VALUES
('adventure-works\shu0', 10, '150-555-0127');
...
VALUES
(9, 'adventure-works\shu0', 11, '926-555-0159');
